...
| -- | --- | ---- | ----------- |
| Raif Eka Rianda | TI.A2.20 | 312010254 | Bahasa Pemrograman |
...
Setelah user memilih data, Misalnya user ingin merubah NIM dari mahasiswa dengan nama Raif , Maka akan muncul tampilan seperti ini :
...
Sebelum saya menjalankan fitur ini, saya akan menambahkan 1 data lagi dengan nama Raif Rian
